...
export class Application implements Initializable {
    private static actionHistory: Action[] = [];
    private static undoneActions: Action[] = [];
    public static editor1View: Editor1ViewModel;
    public static editor2View: Editor2ViewModel;
    public static editor3View: Editor3ViewModel;
    ...
    static createEditors(): void {
        this.editor1View = new Editor1ViewModel(
            ...
            new Editor1(this.imageUploader.getUploadedImageElement())
        )
