...
interface CvMat {
  ...
  setTo(value: CvScalar | number[], mask?: CvMat): void;
...
interface CvMatConstructor {
  new (): CvMat;
  new (rows: number, cols: number, type: number, scalar?: CvScalar | number[]): CvMat;
...
interface CvNamespace {
  ...
  bitwise_not(mat: CvMat, mat1: CvMat): unknown;
