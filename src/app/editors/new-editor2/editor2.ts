...
@Component({
  selector: 'new-editor2',
  imports: [BaseEditorComponent],
  templateUrl: './new-editor2.html',
  styleUrls: ['./new-editor2.css'],
})
export class NewEditor2 extends AbstractEditor {
  public contours: any;
  private contourMap: any;
  private selectedContours: Set<number> = new Set();
  private isContourDeleted: boolean[] = [];
